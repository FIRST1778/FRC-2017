...
public class AutoChooser {
	...
	// debug networks
	public static final int TURNING_FOREVER = 9;
	public static final int PACING_FOREVER = 10;
	...
	public AutoChooser() {
		...
		chooser_gears.addObject("TURNING_FOREVER", new ModeSelection(TURNING_FOREVER));
